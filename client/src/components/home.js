        ...
        return (
            <div className="container-fuid">
              <div className="row" style={{ margin: '1%' }}>
                <div className="col-6" style={{ background: 'url(images/booksBG.jpg)' }}>
                ...
                <div className="col-6" style={{ textAlign: 'left' }}>
                    ...
                    home to blogs and chats for all kinds of readers and writers, free to participate and follow, even if you don't intend to purchase anything. Just
                    take part in the conversation!</p>
                    <p>Our top-of-the-line website has a gorgeous <b>React</b> frontend, a very efficient <b>ExpressJS</b> web interface, in the marvelous MVC (Model-View-Controller) architecture,
                    with a wonderful <b>Node.js</b> backend, and an incredible, very non-relational <b>MongoDB</b> database.</p>
              ...
              <div className="container-fluid" style={{ textAlign: 'center', width: '12%' }}>
                <div className="row">
                  <div className="col-sm-3">
                    <a href="https://facebook.com"><i className="fa fw fa-facebook"/></a>
                  </div>
                  <div className="col-sm-3">
                    <a href="https://twitter.com"><i className="fa fw fa-twitter"/></a>
                  </div>
                  <div className="col-sm-3">
                    <a href="https://plus.google.com"><i className="fa fw fa-google-plus"/></a>
                  </div>
                  <div className="col-sm-3">
                    <a href="https://instagram.com"><i className="fa fw fa-instagram"/></a>
                  </div>
                </div>
              </div>
            </div>
